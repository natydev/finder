...
ActiveRecord::Schema.define(version: 20_200_102_142_948) do
  ...
  create_table 'allowances', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[allowanceable_type allowanceable_id], name: 'index_allowances_on_allowanceable_type_and_allowanceable_id'
